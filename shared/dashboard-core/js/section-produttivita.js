...
/* Pivot Collaboratori (kit Caso 1) · usa helper buildPivotCard (pivot-tree.js) */
function _prodRenderPivot() {
  ...
  buildPivotCard({
    containerId: 'sec-produttivita',
    cardId: 'prodPivotCard',
    stateNamespace: 'prod',
    title: '🌳 Pivot Collaboratori · esplora gerarchico',
    description: 'Scegli ordine dimensioni nei 4 livelli. Clicca ▶ per espandere, riga per drill pop-up.',
    dims: {
      ...
      anno:         { label: 'Anno avvio',             extract: _yearOf },
    ...
    defaultDims: ['agente', 'status', 'anno', ''],
    items: filtered,
  });
}
