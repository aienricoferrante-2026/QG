...
const STATUS_COLORS = { 'Nuova': '#3b82f6', 'Attesa Pro-forma': '#f59e0b', 'Persa': '#ef4444', 'Accettato': '#10b981', 'Offerta Inviata': '#8b5cf6', 'Da Richiamare': '#06b6d4' };
const PREV_COLORS = { 'Offerta presentata': '#3b82f6', 'Con Offerta': '#10b981' };
